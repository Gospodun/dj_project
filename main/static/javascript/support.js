...
const appealMenu = document.querySelector('.appeal__menu')
const modalDropItem = document.querySelectorAll('.modal__drop-item')

appealMenu.addEventListener('click', () => {
    modalDrop.classList.toggle('active');
})
